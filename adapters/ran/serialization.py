"""ADCOS 5G RAN integration serialization (WORK-020).

Canonical-JSON serialization for the RAN integration boundary's
...
excluded from canonical state; mirrors the WORK-018/019/020
discipline).  No vendor SDK, no radio, no randomness.
"""
