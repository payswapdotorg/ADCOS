...
from .capability import (
    ...
    MAX_MEASUREMENTS_PER_ACTIVATION,
...
__all__ = [
    ...
    "validate_profile_versions",
    "validate_resource_mapping_entries",
    # M007: the 1.1 capability-oriented execution boundary (frozen
    # 1.1 section 6; R7-CORE-001/DEC-0101).  The WORK-016 surface
    # above is unchanged; the M007 additions are purely additive.
    "CAPABILITY_OPERATIONS",
    "CAPABILITY_TRANSLATION_MAP",
    "CapabilityAdapter",
    "CapabilityView",
