...
**R7 ACTIVE (DEC-0101) — Architecture 1.1 is the sole normative forward architecture, FROZEN with ACR-014 ACCEPTED; M001 ACCEPTED (DEC-0100); M002 Connectivity Contract Core ACCEPTED (DEC-0102, merge `0ffdf47`); the bounded R7 program authorization R7-CORE-001 covers the charter child scopes M002-M014; M003 — Offers and Provider Capability Exchange is the current child work item (implementing).**
