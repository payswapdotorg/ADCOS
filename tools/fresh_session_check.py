...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.0"', "roadmap must be advanced to the post-M003/M013-acceptance version 2.0"),
