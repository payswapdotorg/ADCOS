...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.19"', "roadmap must be advanced to the v2.19 M021-acceptance version"),
