...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.5"', "roadmap must be advanced to the post-M004-acceptance version 2.5"),
