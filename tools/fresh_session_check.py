...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.21"', "roadmap must be advanced to the v2.21 M023-acceptance version"),
