...
def main() -> int:
    ...
    required_markers = [
        ...
        (resume, "M021 — Wireline Access Adapters is ACCEPTED", "resume protocol must record the M021 acceptance (DEC-0122)"),
        (resume, "M022 — Non-Terrestrial Access Adapters is ACCEPTED", "resume protocol must record the M022 acceptance (DEC-0123)"),
        (resume, "M023 — Future Technology Extension Drill is ACCEPTED", "resume protocol must record the M023 acceptance (DEC-0124)"),
        (resume, "M024 — Future Access Convergence is ACCEPTED", "resume protocol must record the M024 acceptance (DEC-0125 — the R9 gate completion)"),
        (resume, "R9 — Future Access Technology is COMPLETE", "resume protocol must record the R9 gate completion (DEC-0125 — the terminal gate; the roadmap gate sequence R0-R9 complete)"),
