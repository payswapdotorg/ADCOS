...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.8"', "roadmap must be advanced to the post-M007-acceptance version 2.8"),
