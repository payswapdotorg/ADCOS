...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.14"', "roadmap must be advanced to the post-M017-acceptance version 2.14"),
    ...
    for marker in ['roadmap_version: "2.14"', "program_state: R8_RESILIENCE_MOBILITY_AND_SCALE_ACTIVE", "execution_mode: implementing", "active_work_item: M019", "active_authorization: R8-CORE-001", "next_gate: R9_FUTURE_ACCESS_TECHNOLOGY", "completion_decision: DEC-0100", "activation_decision: DEC-0101", "completion_decision: DEC-0109", "completion_merge_sha: 344cd64e8396c7e388e31a50635ddff16bb4ea14", "activation_decision: DEC-0114", "authorization: \"R8-CORE-001\"", "child_acceptance_decisions: \"M015 accepted by DEC-0115 (head 95a65a5, merge d77a561); M016 accepted by DEC-0116 (head 0d5cfb7, merge a0ebd019); M017 accepted by DEC-0117 (head f016124, merge 438acb66)"]:
        if marker not in roadmap:
            failures.append(f"roadmap.yaml missing current authoritative marker: {marker}")

    for marker in ["mode: implementing", "active_work_item: M019", "active_authorization: R8-CORE-001", "current_child_work_item: M019", "r8_activation_decision: DEC-0114", "m015_acceptance_decision: DEC-0115", "m016_acceptance_decision: DEC-0116", "m017_acceptance_decision: DEC-0117", "R8-CORE-001"]:
