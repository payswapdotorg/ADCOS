...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.6"', "roadmap must be advanced to the post-M005-acceptance version 2.6"),
    ...
    for marker in ['roadmap_version: "2.6"', "program_state: R7_UNIVERSAL_CONNECTIVITY_COMMERCE_ACTIVE", "execution_mode: implementing", "active_work_item: M006", "active_authorization: R7-CORE-001", "next_gate: R7_UNIVERSAL_CONNECTIVITY_COMMERCE", "completion_decision: DEC-0100", "activation_decision: DEC-0101"]:
        if marker not in roadmap:
            failures.append(f"roadmap.yaml missing current authoritative marker: {marker}")

    for marker in ["mode: implementing", "active_work_item: M006", "active_authorization: R7-CORE-001", "current_child_work_item: M006", "program_authorization: R7-CORE-001", "R7-CORE-001"]:
