...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.20"', "roadmap must be advanced to the v2.20 M022-acceptance version"),
