...
def main() -> int:
    ...
    required_markers = [
        ...
        (roadmap, 'roadmap_version: "2.4"', "roadmap must be advanced to the post-M012-acceptance version 2.4"),
